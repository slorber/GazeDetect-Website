...
higher confidence than all others. The data shows that you have a <br/>

## **6%** chance of autism

<br/>
however, we recommend taking the specific autism test below to confirm.
Other disease were detected but were of so low confidence, that they are considered
to be false positives. For this reason, we will be comparing you results to the autism benchmark.
...
:::info
Here are some resources to learn more about your condition: <br/>
https://www.autismspeaks.org/what-autism<br/>
https://www.cdc.gov/ncbddd/autism/facts.html<br/>
...
import VideoResult from './module/analysis/result'
